...
public class GeonamesProducer {
    ...
    private void collectParents() throws Exception {
    ...
    private void features() throws Exception {
    ...
    private void populateCodes() throws IOException {
    ...
    public static void main(String... args) throws Exception {
        GeonamesProducer converter = new GeonamesProducer();
        converter.populateCodes();
